function LeaderBoardTable({ puzzle }) {
  ...
  return (
    <div className="w-full border rounded-lg p-2 shadow-sm bg-white">
      <h2 className="text-2xl font-bold mb-3 text-center">{puzzle.puzzle_title}</h2>
      <table className="table-auto w-full text-sm border-collapse">
        <thead>
          <tr className="bg-gray-100">
            <th className="border-b px-2 py-1 text-lg text-left">User</th>
            <th className="border-b px-2 py-1 text-lg text-center">🟢 Attempts</th>
            <th className="border-b px-2 py-1 text-lg text-center">✅ Success</th>
            <th className="border-b px-2 py-1 text-lg text-center">❌ Fails</th>
          </tr>
        </thead>
        <tbody>
